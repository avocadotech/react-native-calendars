...
class CalendarList extends Component {
  ...
  scrollToMonth(m) {
    ...
    const scrollAmount = (this.calendarWidth * this.pastScrollRange) + (diffMonths * this.calendarWidth);
  ...
  getItemLayout(data, index) {
    return {
      length: this.props.horizontal ? this.props.calendarWidth || this.calendarWidth : this.calendarHeight,
      offset: (this.props.horizontal ? this.props.calendarWidth || this.calendarWidth : this.calendarHeight) * index,
      index,
    };
  }
  ...
  // scrollToItem = () => {
  //   const index = this.getMonthIndex(this.state.openDate);
  //   console.log(index)

  //   setTimeout(() => this.listView.scrollToIndex({
  //     index: this.getMonthIndex(this.state.openDate)
  //   }), 100);
  // }
  ...
  render() {
    return (
      <FlatList
        ...
        refreshing={!this.state.rows.length}
